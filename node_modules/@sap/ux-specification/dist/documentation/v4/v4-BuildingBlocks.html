...
<script>
    var floorPlanIcon;
    var treeData = {"name":"BuildingBlocks","description":"SAP Fiori elements for OData V4<br>@sap/ux-specification version 1.124.3","type":"schema","children":[{"name":"$filePath","children":[],"type":"string"}]};
